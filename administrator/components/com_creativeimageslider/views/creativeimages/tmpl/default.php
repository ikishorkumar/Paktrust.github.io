...
<form action="<?php echo JRoute::_('index.php?option=com_creativeimageslider'); ?>" method="post" name="adminForm" id="adminForm">
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_slider_id" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_CREATIVEIMAGESLIDER_SELECT_SLIDER');?></option>
				<?php echo JHtml::_('select.options', $this->slider_options, 'value', 'text', $this->state->get('filter.slider_id'));?>
			</select>
		</div>
	</fieldset>
	<div class="clr"> </div>
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<?php if ($saveOrder) :?>
					<?php echo JHtml::_('grid.order',  $this->items, 'filesave.png', 'creativeimages.saveorder'); ?>
				<?php endif; ?>
				</th>
