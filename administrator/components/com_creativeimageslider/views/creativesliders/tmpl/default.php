	...
	<fieldset id="filter-bar">
		...
		<div class="filter-select fltrt">
			...
			<select name="filter_category_id" class="inputbox" onchange="this.form.submit()">
				<option value=""><?php echo JText::_('COM_CREATIVEIMAGESLIDER_SELECT_CATEGORY');?></option>
		...
		<thead>
			<tr>
				...
				<th width="10%">
					...
					<?php if ($saveOrder) :?>
						<?php echo JHtml::_('grid.order',  $this->items, 'filesave.png', 'creativesliders.saveorder'); ?>
					<?php endif; ?>
				</th>
